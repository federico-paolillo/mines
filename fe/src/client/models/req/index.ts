 ...
 */
// @ts-ignore
export function serializeMoveDto(writer: SerializationWriter, moveDto: Partial<MoveDto> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!moveDto || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeNewGameDto(writer: SerializationWriter, newGameDto: Partial<NewGameDto> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!newGameDto || isSerializingDerivedType) { return; }
